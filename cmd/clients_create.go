...
func init() {
	...
	clientsCreateCmd.Flags().String("jwks-uri", "", "Define the URL where the JSON Web Key MustSet should be fetched from when performing the \"private_key_jwt\" client authentication method")
